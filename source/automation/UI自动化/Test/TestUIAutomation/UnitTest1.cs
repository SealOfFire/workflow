...
namespace TestUIAutomation
{
    public class UnitTest1
    {
        ...
        public void Test4()
        {
            ...
            GRPCCommon.Request request1 = new GRPCCommon.Request { Id= Guid.NewGuid().ToString(), Command = "hover" };
            ...
            //this.nativeMessageClient.Write(processMessage);
            GRPCCommon.Response? result1 = this.nativeMessageClient.Send(request1);
            //ProcessMessage result1 = this.nativeMessageClient.Send("", processMessage);

            GRPCCommon.Request request2 = new GRPCCommon.Request { Id= Guid.NewGuid().ToString(), Command = "hover" };
            ...
            GRPCCommon.Response? result2 = this.nativeMessageClient.Send(request2);
